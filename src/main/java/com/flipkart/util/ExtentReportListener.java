...
public class ExtentReportListener extends TestBase implements ITestListener, IAnnotationTransformer {
	...
	public synchronized void onTestFailure(ITestResult result, ITestAnnotation annotation, Class testClass, Constructor testConstructor, Method testMethod) {
		//Logic Implemented to Retry Test Execution for Failed Tests.
		RetryAnalyzer retryAnalyzer = new RetryAnalyzer();
		if(retryAnalyzer.retry(result)==false) {
